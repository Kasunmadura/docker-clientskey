...
docker run  -id -p 27017:27017 --name clientskeymongo --network clientskey --ip 10.0.1.101 --name mongodb --add-host='appapi.ck.com:10.0.1.102' --add-host='app.clientskey.com:10.0.1.103' --add-host='db.ck.com:10.0.1.101' mongo:latest
docker run  -id -p 3333:5000 -v /root/test/server:/app --network clientskey --ip 10.0.1.102 --name appapi --add-host='appapi.ck.com:10.0.1.102' --add-host='app.clientskey.com:10.0.1.103' --add-host='db.ck.com:10.0.1.101'  kasunmadura/clientskeyapi:v1
